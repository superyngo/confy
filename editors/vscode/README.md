...
3. `npm run package` → `confy-vscode-0.2.0.vsix`.

## Install / use

- `code --install-extension confy-vscode-0.2.0.vsix`
...
- Command palette: **confy: Open Text Editor to the Side** — the real text
  editor, editable and live in both directions (shared `TextDocument`).
