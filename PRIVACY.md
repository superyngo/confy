...
- **No data transmission.** Files you open and edit stay on your device (or,
  ...
  anywhere.
- **Network activity.** The only network request the app ever makes is the
  optional "Open from URL" feature, which fetches a URL you explicitly
  supply. No other network activity occurs.
