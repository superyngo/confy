...
SSOT: `docs/plan/2026-08-28-json-jsonc-parser-simplification-ssot.md`
(background investigation + the three consensus decisions this design
implements). Motivated by
`docs/plan/2026-08-28-comment-advisory-followup-issues.md` issue #1.
...
`docs/reference/glossary.md`'s **"JSONC upgrade"** glossary entry and
...
2026-08-28, during the grill round — see current `docs/reference/glossary.md`/`CLAUDE.md`
...
left to name. `comment_advisory` (`docs/reference/glossary.md`'s existing entry, unchanged)
