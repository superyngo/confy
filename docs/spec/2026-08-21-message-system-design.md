...
Approved in chat 2026-08-21. First spec review 2026-08-21 — decisions in §11; second review
2026-08-21 — decisions in §12.
...
| 6 | Docs: TUI.md, WEBUI.md, docs/reference/glossary.md (glossary: Notice/Severity), CLAUDE.md module map, CHANGELOG | consistency pass |
...
- **Q8** Glossary updates (landed during review): `docs/reference/glossary.md` **Notice**
...
- **Q2** `NoticeSource` is developer-facing metadata: it rides the wire and
  ...
  prefix. `docs/reference/glossary.md` says so explicitly.
