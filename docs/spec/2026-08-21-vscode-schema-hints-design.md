...
avoid conflating them. `docs/reference/glossary.md`'s Schema section defines neither term
...
- **Diagnostics update** (skipped entirely when `diagnosticsDeferred`):
  ...
  `docs/reference/glossary.md`'s "Soft constraint" principle (a Violation never blocks
