...
Four entries added to `docs/reference/glossary.md`'s Language section (**Overflow menu**,
...
Read-only rejection already exists in core (docs/reference/glossary.md **Read-only node**: rejects edit,
...
**Docs and record**
- docs/reference/glossary.md — the four §1 terms and the Remark label line. **Done.**
