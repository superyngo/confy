...
**Spec:** `docs/spec/2026-08-10-json-schema-support-design.md` (grilled/finalized). Every task below traces to a section of that spec.
...
- New docs/reference/glossary.md vocabulary (**JSON projection**, **Violation**, **Soft constraint**) is already recorded — code should use these exact terms in doc comments.
...
`docs/spec/2026-08-10-json-schema-support-design.md`'s
