...
- Read `CLAUDE.md` (architecture section freshly rewritten — it is accurate) and `docs/reference/glossary.md`
  (canonical glossary: Node/Root/Branch/Leaf/Scalar/Comment/Remark; never "Entry").
- Closed plan for background: `docs/plan/2026-06-08-cst-backend-migration.md`.
