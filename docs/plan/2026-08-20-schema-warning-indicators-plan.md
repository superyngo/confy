...
`docs/plan/2026-08-18-row-state-visual-language-phase1.md` (structural template for
this doc).
...
- Test: append to `ui.rs`'s existing `mod tests` block, following the buffer-inspection pattern
  ...
  (`docs/plan/2026-08-18-row-state-visual-language-phase1.md:59-91` for the idiom;
