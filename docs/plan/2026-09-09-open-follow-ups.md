...
Two rows open. Re-verified against the code on 2026-09-18: of the three rows the 2026-09-17
...
the debug docs' fix plans verbatim without checking them against `git log`. Only the residues
below are real.
