...
**Source of truth:** the spec at `docs/spec/2026-05-27-confy-toml-config-editor-design.md`. Section refs (§N) below point into it. Terminology follows `docs/reference/glossary.md` (Node/Root/Branch/Leaf — never "Entry").
...
- [ ] **Step 3: Create CLAUDE.md** — build/test commands (`cargo build/test/clippy/fmt/run`), the architecture summary (CST projection, `ConfigDocument` trait, module map), and a pointer to `docs/reference/glossary.md` for terminology.
