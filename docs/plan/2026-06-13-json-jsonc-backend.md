...
- Docs: `CHANGELOG.md`, `CLAUDE.md`, `docs/reference/glossary.md`, `README.md`.
...
> Spacing edge: the spec accepts that "multiline-array element insert/delete spacing is not yet byte-perfect" for TOML; hold JSON to the inline + simple-multiline cases the tests cover, and document any residual edge in docs/reference/MUTATIONS.md (Task 19).
...
## Task 22: Documentation — CHANGELOG, CLAUDE.md, docs/reference/glossary.md, README

**Files:** `CHANGELOG.md`, `CLAUDE.md`, `docs/reference/glossary.md`, `README.md`, `Cargo.toml`
...
- [ ] **Step 3: docs/reference/glossary.md** — add glossary entries: **Opaque node** (forward-ref to Phase 3) / **Read-only node**, **JSONC upgrade**, **DocFormat**, and the `[S:null]`/`[T/M]`/`[F:exp ]` tags.
...
```bash
git add CHANGELOG.md CLAUDE.md docs/reference/glossary.md README.md Cargo.toml
