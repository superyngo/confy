...
**Spec:** `docs/spec/2026-08-28-json-jsonc-comment-gate-removal-design.md`
...
- [x] **Step 6: Final commit** — folded into a follow-up `docs:` commit (`CLAUDE.md`/`docs/reference/glossary.md` JSONC-upgrade description updates + a `CHANGELOG.md` entry), since those two doc files had been edited in an earlier phase of this session (spec-writing) but never committed.
