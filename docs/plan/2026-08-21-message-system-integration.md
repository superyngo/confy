...
**Spec:** `docs/spec/2026-08-21-message-system-design.md` (the plan argues from this spec — executors MUST read both; exhaustive data tables — the 45-key severity mapping in §2.2, the 38 touch-toast call sites in §5.2/§12 fact verifications — are **not** duplicated here and must be read from the spec).
...
| `docs/reference/glossary.md`, `docs/TUI.md`, `docs/WEBUI.md`, `CLAUDE.md`, `CHANGELOG.md` | Phase 6 docs pass |
...
```bash
git add docs/TUI.md docs/WEBUI.md docs/reference/glossary.md CLAUDE.md CHANGELOG.md
git commit -m "docs: message-system integration — TUI.md/WEBUI.md/docs/reference/glossary.md/CLAUDE.md/CHANGELOG updates"
```
