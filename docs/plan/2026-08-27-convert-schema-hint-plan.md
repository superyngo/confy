...
`docs/reference/glossary.md` glossary term (currently undocumented there) and
...
5. **Formalize "Schema hint" in `docs/reference/glossary.md`.** Add a new
...
- `docs/reference/glossary.md:167-176,290-300` — Conversion and Schema
