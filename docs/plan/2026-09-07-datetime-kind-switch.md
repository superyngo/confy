...
- Modify: `docs/reference/TUI.md` (the `K` kind-switch material), `docs/reference/MUTATIONS.md`
...
- `docs/reference/MUTATIONS.md` *Kind switch (`K`) rules*: record that datetimes are the one `K`
