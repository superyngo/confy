...
- Spec: `docs/spec/2026-07-15-vscode-extension-design.md` (M1.5 goal in
...
**Files:**
- Modify: `docs/spec/2026-07-15-vscode-extension-design.md`
...
(2026-07-16)** — see docs/plan/2026-07-16-vscode-m1-5-shared-dirty-state.md;
...
```bash
git add docs/spec/2026-07-15-vscode-extension-design.md editors/vscode/README.md CHANGELOG.md CLAUDE.md WEBUI.md
