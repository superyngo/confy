# Pointer-drop `PasteSlot` alignment — probe
Status: Resolved (2026-09-01)

The fix landed as commit `5e5d9d1` (ADR
[0010](../adr/0010-pointer-drops-resolve-through-pasteslot.md)). The sibling
[`2026-09-01-pointer-drop-pasteslot-probe/`](2026-09-01-pointer-drop-pasteslot-probe/) directory
holds the frozen evidence: [`probe3.mjs`](2026-09-01-pointer-drop-pasteslot-probe/probe3.mjs),
the scratch harness described below.

It is the scratch harness that measured the bug against the **real wasm core**
...
node docs/debug/2026-09-01-pointer-drop-pasteslot-probe/probe3.mjs
```
