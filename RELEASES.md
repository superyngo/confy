...
| Windows Microsoft Store (`.msix`) | Partner Center submission | built by `release.yml` every tag, submitted manually | v0.17.0 artifact | Not yet published — awaiting Partner Center registration |
